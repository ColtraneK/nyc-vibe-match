...
export const NEIGHBORHOODS: Neighborhood[] = [
  ...
  { id: "bushwick", n: "Bushwick", b: "Brooklyn", ln: "M/J", c: "#E8956A", tg: "Where the artists actually live", quiet: 3, food: 7, nl: 9, transit: 5, green: 3, safe: 4, val: 7, x: 572, y: 370, vb: "Murals on every surface. Your neighbor is a painter or a DJ. The rent is the last honest thing in Brooklyn." },
  ...
  // QUEENS
  { id: "astoria", n: "Astoria", b: "Queens", ln: "N/W", c: "#E8A87C", tg: "Everything you need, none of the pretense", quiet: 7, food: 9, nl: 5, transit: 7, green: 8, safe: 7, val: 8, x: 580, y: 200, vb: "Greek bakeries next to Egyptian spots next to Colombian joints. Your barber knows your name." },
